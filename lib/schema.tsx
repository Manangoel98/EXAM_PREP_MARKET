    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'SAT Prep',
        description: 'SAT preparation with AI tutor, practice tests, and study plans',
      ...
      },
      {
        ...
        position: 2,
        name: 'ACT Prep',
        description: 'ACT preparation with full-length practice tests and AI tutoring',
        url: `${baseUrl}/exams/act`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 3,
      ...
      },
      {
        ...
        position: 4,
        name: 'AI Tutor',
        description: '24/7 AI tutoring for SAT, ACT, GRE - unlimited help',
      ...
      },
      {
        ...
        position: 5,
        name: 'Practice Tests',
        description: 'Full-length SAT & ACT practice tests with instant scoring',
      ...
      },
      {
        ...
        position: 6,
        name: 'Try Free',
        description: 'Free SAT practice questions - no account required',
      ...
      },
      {
        ...
        position: 7,
        name: 'How It Works',
        description: 'How NomoExam helps you improve your SAT score',
      ...
      },
      {
        ...
        description: 'NomoExam vs Khan Academy, Kaplan, Princeton Review',
        url: `${baseUrl}/compare`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 9,
        name: 'Android App',
        description: 'Download NomoExam SAT prep app on Google Play',
        url: `${baseUrl}/download-exam-app`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 10,
        name: 'SAT Study Guide',
